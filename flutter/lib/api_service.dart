...
class ApiService {
  final String baseUrl = 'https://186e-180-245-90-159.ngrok-free.app/data';
  ...
  try {
    ...
    print('Error fetching data: $e'); // Menampilkan error di konsol
    rethrow;
  }
}
  ...
  Future<String> addData(Map<String, dynamic> data) async {
    try {
      ...
      if (response.statusCode == 201) {
        ...
        throw Exception('Failed to add data: ${response.statusCode} - ${response.body}');
      }
    } catch (e) {
      rethrow;
    }
